...
from _common import (
    ...
    get_quality_score, build_asset_query
)
...
def format_summary(data: Dict[str, Any]) -> str:
    ...
    if top:
        ...
        for i, photo in enumerate(top[:20], 1):
            ...
            lines.append(f"       Q:{photo['quality_score']:.3f} | {photo['size_formatted']} | {photo['dimensions']}{fav}")
...
Examples:
  ...
  %(prog)s --output best.json
    ...
    parser.add_argument('--top', type=int, default=50,
                        help='Number of top photos to return (default: 50)')
    parser.add_argument('--hidden-gems', action='store_true',
                        help='Only show photos that are NOT favorited')
