...
from _common import datetime_to_coredata, coredata_to_datetime
...
class TestBestPhotos:
    ...
    def test_format_summary(self):
        ...
        data = {
            'top_photos': [
                {'filename': 'test.jpg', 'quality_score': 0.9, 'size_formatted': '4 MB',
                 'dimensions': '4032x3024', 'is_favorite': False,
                 'detail_scores': {'composition': 0.95, 'lighting': 0.88}}
            ],
            'summary': {
                'total_with_scores': 100, 'total_above_threshold': 50,
                'hidden_gems': 40, 'favorited_high_quality': 10,
                'total_favorites': 15, 'min_quality_threshold': 0.7, 'top_n': 50,
            },
            'quality_distribution': {
                'excellent': 10, 'good': 40, 'average': 30,
                'below_average': 15, 'poor': 5,
            },
        }
...
class TestLocationMapper:
    ...
    def test_format_summary(self):
        ...
        data = {
            'locations': [{'centroid_lat': 41.5, 'centroid_lon': -90.5, 'photo_count': 10,
                          'favorites': 2, 'is_trip': True, 'total_size_formatted': '5 MB',
                          'first_photo': '2025-01-01', 'last_photo': '2025-01-05', 'people': []}],
            'trips': [],
            'summary': {'total_with_location': 100, 'total_without_location': 20,
                       'location_coverage': 83.3, 'unique_locations': 5, 'identified_trips': 1,
...
class TestOnThisDay:
    ...
    def test_format_summary(self):
        ...
        data = {
            'target_date': '2026-03-03', 'target_month_day': 'March 3',
            'window_days': 0,
            'years': [
                {'year': 2024, 'years_ago': 2, 'photo_count': 5, 'favorites': 1,
...
class TestAlbumAuditor:
    ...
    def test_find_junction_table(self):
        ...
        album_col, asset_col, table_name = result
    ...
    def test_format_summary(self):
        ...
        data = {
            ...
            'overlaps': [{'album_1': 'A', 'album_2': 'B', 'album_1_count': 10,
                         'album_2_count': 20, 'shared_count': 5,
                         'overlap_pct_album_1': 50, 'overlap_pct_album_2': 25}],
            'orphans': {'count': 500, 'total_size': 1000000, 'total_size_formatted': '1 MB'},
            'summary': {'total_albums': 10, 'albums_with_photos': 8, 'empty_albums': 1,
                       'tiny_albums': 2, 'total_photos': 1000, 'photos_in_albums': 500,
                       'orphan_photos': 500, 'albums_with_overlap': 1},
        }
        output = format_summary(data)
        assert '📁' in output
